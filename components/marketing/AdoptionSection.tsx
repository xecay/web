        ...
        <Grid columns={{ '@initial': 1, '@bp1': 2 }} gap={{ '@initial': 4, '@bp1': 7, '@bp2': 9 }}>
          ...
          <Box>
            ...
            <Paragraph>
              ...
              incentive aligned to protocol. <br/> <br/> * Except provided in situations where players are sufficiently patient, there exists a Nash Equilibrium where collision may arise.
